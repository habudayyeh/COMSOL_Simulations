...
% above_metal.m
%
% Model exported on Nov 25 2016, 21:59 by COMSOL 5.2.0.166.
...
model.label('above_metal.mph');

model.comments(['Pz Design 2D center flat low\n\n']);

model.param.set('Lambda', '488[nm]', 'wavelength');
model.param.set('PolymerThickness', 'd');
model.param.set('d', '24.4[nm]');
model.param.set('Period', '750[nm]');
model.param.set('SlitWidth', 'Period-ElementWidth');
model.param.set('SlitHeight', '100[nm]');
model.param.set('ElementWidth', '150[nm]');
model.param.set('Main', '1460[nm]', 'central cavity width');
model.param.set('NRings', '25');
model.param.set('MetalThickness', '500[nm]');
...
model.param.set('Px', '0');
model.param.set('Pz', '1');
...
model.material('mat3').selection.set([1 2 3 4 5 6 9 10 11]);
...
model.coordSystem('pml1').selection.set([1 2 3 4 6 9 10 11]);

model.physics.create('emw', 'ElectromagneticWaves', 'geom1');
model.physics('emw').create('sctr1', 'Scattering', 1);
model.physics('emw').feature('sctr1').selection.set([1 2 3 5 7 9 14 24 29 30 31 32]);
...
model.physics('emw').feature('ffd1').feature('ffc1').selection.set([10 11 13 25]);

model.mesh('mesh1').create('ftri1', 'FreeTri');
model.mesh('mesh1').create('map1', 'Map');
model.mesh('mesh1').feature('ftri1').selection.geom('geom1', 2);
model.mesh('mesh1').feature('ftri1').selection.set([5 7 8]);
model.mesh('mesh1').feature('map1').selection.geom('geom1', 2);
model.mesh('mesh1').feature('map1').selection.set([1 2 3 4 6 9 10 11]);
model.mesh('mesh1').feature('map1').create('dis1', 'Distribution');

model.result.table.create('evl2', 'Table');

model.view('view1').axis.set('abstractviewxscale', '0.03678872436285019');
model.view('view1').axis.set('ymin', '-5.223605155944824');
model.view('view1').axis.set('xmax', '11.830001831054688');
model.view('view1').axis.set('abstractviewyscale', '0.03678872436285019');
model.view('view1').axis.set('abstractviewbratio', '-0.6447210311889648');
model.view('view1').axis.set('abstractviewtratio', '0.6288221478462219');
model.view('view1').axis.set('abstractviewrratio', '-0.23113632202148438');
model.view('view1').axis.set('xmin', '-11.641204833984375');
model.view('view1').axis.set('abstractviewlratio', '0.2354271560907364');
model.view('view1').axis.set('ymax', '6.144110679626465');
...
model.material('mat2').label('metal');
...
model.material('mat2').propertyGroup('def').func('rho').set('plotargs', {'pA' '0' '1'; 'T' '0' '1'});
...
model.material('mat2').propertyGroup('def').func('cs').set('plotargs', {'T' '0' '1'});
model.material('mat2').propertyGroup('def').func('cs').set('argders', {'T' 'd(sqrt(1.4*287*T),T)'});
model.material('mat2').propertyGroup('def').set('relpermeability', {'1' '0' '0' '0' '1' '0' '0' '0' '1'});
model.material('mat2').propertyGroup('def').set('relpermittivity', {'-34.5+j*8.5' '0' '0' '0' '-34.5+j*8.5' '0' '0' '0' '-34.5+j*8.5'});
...
model.material('mat3').label('Glass 1');
...
model.material('mat3').propertyGroup('def').set('relpermittivity', {'1.5' '0' '0' '0' '1.5' '0' '0' '0' '1.5'});
