...
% free_space.m
%
% Model exported on Nov 25 2016, 22:10 by COMSOL 5.2.0.166.
...
model.label('dielectriclayer.mph');
...
model.geom('geom1').feature('r1').set('size', {'MetalLength' '5[um]'});
...
model.material('mat3').selection.set([4 5 9 10 14 15]);
...
model.coordSystem('pml1').selection.set([1 2 3 4 5 6 10 11 12 13 14 15]);

model.physics.create('emw', 'ElectromagneticWaves', 'geom1');
model.physics('emw').create('sctr1', 'Scattering', 1);
model.physics('emw').feature('sctr1').selection.set([1 2 3 5 7 9 11 13 22 25 34 35 36 37 38 39]);
model.physics('emw').create('epd1', 'ElectricPointDipole', 0);
model.physics('emw').feature('epd1').selection.set([13]);
model.physics('emw').create('lco1', 'LineCurrentOutOfPlane', 0);
model.physics('emw').feature('lco1').selection.set([13]);
model.physics('emw').create('ffd1', 'FarFieldDomain', 2);
model.physics('emw').feature('ffd1').selection.set([7 9]);
model.physics('emw').feature('ffd1').feature('ffc1').selection.geom('geom1', 1);
model.physics('emw').feature('ffd1').feature('ffc1').selection.set([14 15 16 18 21 26 28 30]);

model.mesh('mesh1').create('ftri1', 'FreeTri');
model.mesh('mesh1').create('map1', 'Map');
model.mesh('mesh1').feature('ftri1').selection.geom('geom1', 2);
model.mesh('mesh1').feature('ftri1').selection.set([7 8 9]);
model.mesh('mesh1').feature('map1').selection.geom('geom1', 2);
model.mesh('mesh1').feature('map1').selection.set([1 2 3 4 5 6 10 11 12 13 14 15]);
model.mesh('mesh1').feature('map1').create('dis1', 'Distribution');

model.result.table.create('evl2', 'Table');

model.view('view1').axis.set('abstractviewxscale', '0.01779935322701931');
model.view('view1').axis.set('ymin', '-10.564659118652344');
model.view('view1').axis.set('xmax', '22.05000114440918');
model.view('view1').axis.set('abstractviewyscale', '0.01779935322701931');
model.view('view1').axis.set('abstractviewbratio', '-1.737586259841919');
model.view('view1').axis.set('abstractviewtratio', '1.737586259841919');
model.view('view1').axis.set('abstractviewrratio', '0.05000000819563866');
model.view('view1').axis.set('xmin', '-22.05000114440918');
model.view('view1').axis.set('abstractviewlratio', '-0.05000000819563866');
model.view('view1').axis.set('ymax', '11.564659118652344');
